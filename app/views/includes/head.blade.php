...
<script type="text/javascript" src="/js/k_event.js"></script>
...
<script type="text/javascript">
  /*** Following code (before var _gaq = ..) added to prevent tracking ***/
  // Set to the same value as the web property used on the site
  var gaProperty = 'UA-3197786-1';
  ...
  // Tremporarily deactivate
  /*
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-3197786-1']);
