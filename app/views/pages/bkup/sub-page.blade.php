...
<!-- 
 ...
 -->
    ...
    @foreach($pg_sections as $ps)
        ...
        @if($ps->type == 'h2text')
            <div class="ce ce-headline container">
                <h2 class="anchor" data-anchortext="{{{$ps->anchor_title_de ? $ps->anchor_title_de : ''}}}">{{$ps->headline_de}}</h2>
                <p>{{$ps->intro_de}}
                </p>
            </div>                    
        @endif
    ...
    @if($page->downloads && count($page->downloads) > 0)
        <!-- download start -->
                ...
                <div class="content">
                    <div class="ce-termsofuse">
                        ...
                        <form method="POST" novalidate="novalidate">
                            ...
                            <input type="hidden" name="termsofuse_files">
                            <button type="submit" class="btn btn-default btn-raised active">Download</button>
                        </form>
                    </div>
                </div>
            </div>
