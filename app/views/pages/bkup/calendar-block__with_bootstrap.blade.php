...
?>
  <div id="main_panel_cal" class="row" style="height:<?php echo $firstSlideHeight;?>px; display:block; clear:both;">    
    <div class="col-md-12">
      <div id="main_content_inner_cal" style="width:100%; background:#b5d6dd; clear:both; margin-top:0px; position:relative; vertical-align:middle;">
          ...
          <div style="width:99%; float:left; margin:10px 20px; height:60px; padding:5px; border-bottom:1px solid #fff; clear:both;"><div 
          style="font-size:21px;font-weight:bold; width:100%; margin-top:0px; vertical-align:middle; font-family:Dekka; text-align: center;">VERANSTALTUNGEN</div>
          </div>
          <!--- ->
    ...
    <div id="fs_slide_<?php echo $slide_cnt;?>" class="fs_slide" style="font-size:12px; height:<?php echo $slide_height;?>px;">
        <div class="cal-block" style="width:99%; height:100%; margin:0 auto; text-align:center;">
            ...
            <div style="width:290px; height:0px; margin:0 auto; background:none; clear:both;">
                <div style="width:60px; float:right; margin-top:-24px; font-size:14px; height:31px;">
  ...
  ?>                  
    ...
    ?>
          ...
          <div id="edb_<?php echo $evt['index'];?>" class="evt-day-block white-bdr accordion" style="width:98%; height:100px; position:relative; margin:-54px auto 0px auto; color:#000; clear:both; display:block; background:none; text-align:center; vertical-align:top;"><!-- div1s -->

             <div id="event_title_bar_<?php echo $evt['index'];?>" style="width:100%; margin:5px auto 0 auto; position:relative; top:-10px;" 
             ...
             <div id="more_btn_blk_<?php echo $evt['index'];?>" class="title" style="width:100%; clear:both; margin-top:0px; float:left; text-align:center;"><!-- div2s -->
               
               <!--
               <div id="more_btn_< ?php echo $evt['index'];?>" onclick="showReg('< ?php echo $evt['index'];?>', '< ?php echo $slide_cnt;?>')" 
                  class='more-btn'>&nbsp;</div><!---->
               
               <div class="hide" id="hide_<?php echo $evt['index'];?>" style="width:100%; min-height:460px; background:#fff;"><!-- div3s -->
                  <div style="width:100%; float:left; position:relative; padding:0;"><!-- div4s -->
                     ...
                     <div style="width:32.5%; float:left; margin-left:12px; margin-right:12px;">
                        ...
                        <li style="line-height:8px; margin-top:12px;"><p style="line-height:14px;">Diese Veranstaltung ist Teil des Begleitprogramms<br> zu der Ausstellung
                        </p></li>
                  <?php $is_clustered = false;
                        if(is_array($cluster) && count($cluster) > 0) { 
                          ...
                          $is_clustered = true;
                        ?>
                            <li style="line-height:8px; margin-top:12px;"><h4><?php echo $cluster['title_de'];?></h4><p><?php 
                            echo $cluster['subtitle_de'];?></p></li>

                        <?php if(isset($evt['clustered_dates'])) : ?>
                                <li style="line-height:8px; margin-top:12px;"><p style="line-height:14px;"><span style="font-size:14px; font-weight:bold;">Weitere Termine in dieser Reihe:</span><br>
                        ...
                        if(is_numeric($cluster['cost_all_at_once_adult'])) : ?>
                                <li style="line-height:8px; margin-top:12px;"><p style="line-height:14px;"><span style="font-size:14px; font-weight:bold;">Kosten:</span><br><?php 
                  ...
                  <?php } ?>   
                          ...
                          <li style="line-height:8px; margin-top:-2px;"><p style="line-height:14px;"><span style="font-size:14px; font-weight:bold;">Leitung:</span><br>{{$evt['guide_name']}}</p></li>
                  
                  @if(!empty($evt['meeting_place']))        
                          <li style="line-height:8px; margin-top:-2px;"><p style="line-height:14px;"><span style="font-size:14px; font-weight:bold;">Treffpunkt:</span><br>
                  ...
                  @endif      
                     ...
                     <div style="width:64.6%; float:left; padding-left:14px; text-align:left;"><!-- div5s -->
                       <p class="event-detail" style="text-align:left; width:80%;"><?php echo html_entity_decode($evt['detail_de']); ?>
                        <br><br>
      ...
      <span></span>
                    ...
                    @foreach($price_fields as $pf)
                        @if(isset($evt[$pf]) && floatval($evt[$pf]) > 0)
                             <?php ++$pfCount; ?>
                             <tr>
                                <td style="width:40px; height:29px; padding:0px; border-bottom:0px solid #eee;">
                                  <input type="number" name="<?php echo $pf;?>" id="<?php echo $pf;?>_<?php echo $cnt;?>_inp" value="0" class="price-inp-sel" onclick="this.select();checkNum(this);updateTotal('<?php echo $pf;?>', this, '<?php echo $cnt;?>');" onkeyup="updateTotal('<?php echo $pf;?>', this, '<?php echo $cnt;?>')" style="margin-left:0px; margin-top:0px;"></td>
                                  <td style="width:360px; float:left; padding-left:10px; padding-top:0px; line-height:29px; vertical-align: middle; height:29px; border-bottom:1px solid #eee;"><?php echo ucwords(str_replace(' price', '', str_replace('_', ' ', $pf))). ' Price';?> </td>
                    ...
                    @endforeach    
                           ...
                           <table border="0" class="form-tbl">
                             ...
                             <tr>
                                <td style="width:27%; min-width:180px; background:#eee; line-height: 25px; vertical-align: middle; 
                                    border-bottom:1px solid #fff; padding-left:8px; position:relative;">
                                <label class="myCheckbox" style="width:24px; height:24px; margin-top:2px; float:left;">
                             ...
                             <tr>
                                <td colspan="2" style="background:#fff; line-height: 25px; vertical-align: middle; 
                                    border-bottom:1px solid #fff; padding-left:8px; padding-bottom:10px;" colspan="2"><h4>Zahlung</h4>
...
function showReg(id, slideNo) {
  ...
  if(show_reg) {
      ...
      if($('#event_block_'+id).length) {
        ...
        var scrollPos = $("#event_block_"+id).offset().top - 14;
        $('html, body').animate({
          scrollTop: scrollPos
        }, 700);
...
function adjustHeights() {
    ...
    if(curEventId > 0) {
      ...
      var detailHeight = $('#more_btn_blk_'+curEventId).css('height').replace('px', '');      
      openEventBlockHeight = (parseInt(edbHeight)+parseInt(detailHeight));
    }
    ...
    if(isFormOpen) {
        ...
        detail_block_ht += 500;  // (parseInt(form_height) + (priceFieldCount * 25)) - 130;
    ...
    // if(!animated) { //isClosing) {        
      // if(baseHeight > curBaseHeight) {
        // $('#main_panel_cal').delay(200).animate({ height: mainPanelHeight });
...
$(function() {
    ...
    // main_panel_cal_new_ht = ((parseInt(main_panel_cal_ht) + parseInt(slideHeight)) + 520) + 'px';
});
</script>
...
.myCheckbox span {
    ...
    height: 20px;
    display: block;
    background: url("http://kunsthalle-site.dev/images/checkbox_bg.png");
}

.myCheckbox input:checked + span {
    background: url("http://kunsthalle-site.dev/images/checkbox_on.png");
}
