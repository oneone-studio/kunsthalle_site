...
?>
  ...
  ?>                  
    ...
    <!-- <div id="day_<?php echo $day_index;?>" class="event-day-title"><?php echo strtoupper(strftime($day));?></div> -->
    <?php       
    ...
    ?>
          ...
          <div id="edb_<?php echo $evt['index'];?>" class="evt-day-block white-bdr accordion" style="width:98%; height:100px; position:relative; margin:-24px auto 0px auto; color:#000; clear:both; display:block; background:none; text-align:center; vertical-align:top;"><!-- div1s -->
             ...
             <div id="more_btn_blk_<?php echo $evt['index'];?>" class="title" style="width:100%; clear:both; margin-top:0px; position:relative; float:left; text-align:center;"><!-- div2s -->
               ...
               <div class="hide" id="hide_<?php echo $evt['index'];?>" style="width:100%; min-height:520px; background:#fff;"><!-- div3s -->
                  <div id="line_top" style="width:100%; border-top:1px solid #BCD9E0; position:relative; height:11px; clear:both; margin:2px auto; padding:0;">
                    <div style="width:22px; height:11px; margin:-1px auto; background:url(/images/arrow_open_white.png) no-repeat; background-position: center; z-index:99999;"></div>
                  </div>
                  <div style="width:100%; float:left; position:relative; padding:0;"><!-- div4s -->
                     ...
                     <div style="width:32.5%; float:left; margin-left:12px; margin-right:12px;">
                        ...
                        <li style="line-height:8px; margin-top:12px; padding-bottom:10px;"><span style="font-size:14px;line-height:17px;">Diese Veranstaltung ist Teil des Begleitprogramms<br> zu der Ausstellung</span><br>
                  ...
                  <?php $is_clustered = false;
                        if(is_array($cluster) && count($cluster) > 0) { 
                          ...
                          $is_clustered = true;
                        ?>
                            <div style="width:100%; margin:2px 0px; font-size:14px; font-weight:bold; line-height:17px;"><?php echo $cluster['title_de'];?></div><div style="width:100%; margin-top:6px; clear:both; font-size:14px;"><?php echo $cluster['subtitle_de'];?></div></li>

                        <?php if(isset($evt['clustered_dates'])) : ?>
                                <li style="line-height:8px; margin-top:12px;"><p style="line-height:12px;"><div style="width:100%; clear:both;font-size:14px; font-weight:bold; padding-bottom:6px;">Weitere Termine in dieser Reihe:</div>
                                <ul style="list-style:none; padding-left:0;">
                                 <?php 
                                    for($i=0; $i<count($evt['clustered_dates']); $i++): 
                                         $date = $evt['clustered_dates'][$i];
                                      ?>
                                       <li style="height:13px; margin-top:5px; background:url(/images/arrow.png) no-repeat; padding-left:15px;"><a href="javascript:showEvent('<?php echo $date['index']; ?>', '<?php echo $date['slideNo'];?>', '<?php echo $slide_height;?>')" style="color:#111;font-size:14px;">{{$date['event_date']}}</a>
                        ...
                        if(is_numeric($cluster['cost_all_at_once_adult'])) : ?>
                                <li style="line-height:8px; margin-top:12px;"><p style="font-size:14px;line-height:17px;"><span style="font-size:14px; font-weight:bold;">Kosten:</span><br><?php 
                  ...
                  <?php } ?>   
                          ...
                          <li style="line-height:8px; margin-top:-2px;"><p style="font-size:14px;line-height:17px;"><span style="font-size:14px; font-weight:bold;">Leitung:</span><br>{{$evt['guide_name']}}</p></li>
                  
                  @if(!empty($evt['meeting_place']))        
                          <li style="line-height:8px; margin-top:-2px;"><p style="font-size:14px;line-height:17px;"><span 
                            style="font-size:14px; font-weight:bold;">Treffpunkt:</span><br>
                  ...
                  @if(!empty($evt['event_image']))
                        <div style="width:100%; clear:both; margin:0px 0px 10px 0px;"><img src="http://kh-cms-test.byethost8.com/<?php echo $evt['event_image'];?>" style="max-width:100px;"></div>
                  @endif      

                        <button class="button" onclick="showRegForm('<?php echo $evt['index'];?>', event, this)">ANMELDEN ></button>
                       </div>
                        ...
                        @if(isset($evt[$pf]) && floatval($evt[$pf]) > 0)
                             ...
                             <tr>
                                <td style="width:40px; height:29px; max-height:29px; padding:0px; border-bottom:0px solid #fff;">
                                  <input type="text" name="<?php echo $pf;?>" id="<?php echo $pf;?>_<?php echo $cnt;?>_inp" value="0" class="price-inp-sel" onclick="this.select();updateTotal('<?php echo $pf;?>', this, '<?php echo $cnt;?>');" onkeyup="checkNum(this, event);updateTotal('<?php echo $pf;?>', this, '<?php echo $cnt;?>')" style="font-family:Circular-Book;font-size:14px;margin-left:0px; margin-top:0px; height:100% !important; background:#e8e8e8 !important;"></td>
                                  <td colspan="2" style="height:29px;border-bottom:2px solid #eeeeee;"><div style="width:704px;float:left;"><div 
                                  style="width:360px;font-family:Circular-Book;font-size:14px;float:left; padding-left:10px; padding-top:1px; line-height:29px; vertical-align: middle; height:29px;"><?php //echo $pf;
                                    $pf_label = _t($pf);
                                    echo $pf_label;?> </div>
                                  <div style="width:332px;float:left;font-family:Circular-Book;font-size:14px;line-height:23px; vertical-align: middle; padding-top:0px; height:29px; "><div id="<?php echo $pf;?>_lbl_<?php echo $cnt;?>" style="width:60px;font-family:Circular-Book;font-size:14px;float:left; text-align:right; margin-right:3px;">0</div> &euro;
                                   <input type="hidden" name="<?php echo $pf;?>_<?php echo $cnt;?>" id="<?php echo $pf;?>_<?php echo $cnt;?>" 
                                     value="<?php echo $evt[$pf];?>"></div></div></td>
                             </tr> 
                        @endif     
                    @endforeach    
                             <tr>
                                <td style="width:40px; height:29px; max-height:29px; padding:0px; border-bottom:1px solid #eeeeee;">
                                  &nbsp;</td>
                                  <td colspan="2" style="height:29px;border-bottom:1px solid #eeeeee;"><div style="width:704px;float:left;"><div 
                                  style="width:360px;font-family:Circular-Book;font-size:14px;float:left; padding-left:10px; padding-top:1px; line-height:29px; vertical-align: middle; height:29px;">Gesamt</div>
                                  <div style="width:332px;float:left;font-family:Circular-Book;font-size:14px;line-height:23px; vertical-align: middle; padding-top:0px; height:29px; "><div id="_total_price_<?php echo $cnt;?>" style="width:60px;font-family:Circular-Book;font-size:14px;float:left; text-align:right; margin-right:3px;">0</div> &euro;
                                  
                                  <input type="hidden" name="total_price_<?php echo $cnt;?>" id="total_price_<?php echo $cnt;?>" value="0"></div></div></td>
                             </tr> 
                           </table>                             
                           ...
                           <table border="0" class="form-tbl">
                             <tr>
                               <td style="width:27%; min-width:180px; background:#eee; line-height: 24px; vertical-align: middle; 
                                    border-bottom:2px solid #fff; padding-left:8px;">Name *</td>
                               <td style="width:73%; line-height: 22px; border-bottom:2px solid #eee; vertical-align: middle; background:#ffffff; padding:0px; height:22px;"><input type="text" name="first_name" style="width:100%; margin:0; border:none; background:#ffffff; height:24px;">
                               </td> 
                             </tr>
                             <tr>
                               <td style="width:27%; min-width:180px; background:#eee; line-height: 24px; vertical-align: middle; 
                                    border-bottom:2px solid #fff; padding-left:8px;">Nachname *</td>
                               <td style="width:73%; line-height: 22px; border-bottom:2px solid #eee; vertical-align: middle; background:#ffffff; padding:0px; height:22px;"><input type="text" name="first_name" style="width:100%; border:none; background:#ffffff; height:24px;">
                               </td>  
                             </tr>
                             <tr>
                                <td style="width:27%; min-width:180px; background:#eee;font-size:14px;line-height:17px;vertical-align: top; padding-top:5px; border-bottom:2px solid #fff; padding-left:8px;">Name und Alter der Kinder<br>(Angabe freiwillig) </td>
                                <td style="width:520px; padding:0px; border-bottom:2px solid #eee; background:#ffffff height:73px;"><textarea name="children_detail"  
                                style="border:none;margin:0px;width:100%;font-size:14px;line-height:17px; padding:3px 5px;height:100%;"></textarea> 
                                </td> 
                             </tr>
                             <tr>
                               ...
                               <td style="width:73%; line-height: 22px; border-bottom:2px solid #eee; vertical-align: middle; background:#ffffff; padding:0px; height:22px;"><input type="text" name="email" style="width:100%; border:none; background:#ffffff; height:25px;">
                                </td>  
                             </tr>
                             <tr>
                                <td style="width:27%; min-width:180px; background:#fff; line-height: 25px; vertical-align: middle; 
                                    border-bottom:2px solid #fff; padding-left:0px; position:relative;">
                                <label class="myCheckbox" style="width:24px; height:24px; margin-top:2px; float:left;">
                                    <input type="checkbox" name="is_member" style="border:none; position:absolute; top:-3px; width:10px; margin-right:2px;">
                                    <span></span>
                                </label>
                                <div style="display:inline; margin-top:3px; margin-left:5px; font-family:Circular-Book; font-weight:normal;">Mitglied im Kunstverein *</div></td>
                                <td style="padding:0px; height:24px;border-bottom:2px solid #eee;"><input type="text" name="first_name" style="width:98%; border:none; background:#fff; height:25px; margin-left:0px; padding-left:10px; padding-right:3px;" placeholder="Mitgliedsnummer eintragen"></td>
                             </tr> 
                             <tr>
                                <td colspan="2" style="background:#fff; line-height: 18px; vertical-align: middle; 
                                    border-bottom:1px solid #fff; padding-left:0px; padding-top:15px;font-size:14px; padding-bottom:10px;" colspan="2"><span style="font-size:14px; font-weight:bold;">Zahlung</span><br>
                                  Wir bieten als Zahlungsm&ouml;glichkeit Bankeinzug an.<br>Diese Einzugserm&auml;chtigung gilt nur f&uuml;r die hier aufgef&uuml;hrten Veranstaltungen, danach erlischt sie.
                               </td>
                             </tr>
                             <tr>
                                <td style="width:27%; min-width:180px; background:#eee; line-height: 25px; vertical-align: middle; 
                                    border-bottom:2px solid #fff; padding-left:8px;">IBAN *</td>
                               <td style="width:73%; line-height: 22px; border-bottom:2px solid #eee;vertical-align: middle; background:#ffffff; padding:0px; height:22px;"><input type="text" name="first_name" style="width:100%; border:none; background:#ffffff; height:24px;">
                               </td>  
                             </tr> 
                             <tr>
                                <td style="width:27%; min-width:180px; background:#eee; line-height: 25px; vertical-align: middle; 
                                    border-bottom:2px solid #fff; padding-left:8px;">Kontoinhaber *</td>
                               <td style="width:73%; line-height: 22px; border-bottom:2px solid #eee; vertical-align: middle; background:#ffffff; padding:0px; height:22px;"><input type="text" name="first_name" style="width:100%; border:none; background:#ffffff; height:24px;">
                               </td>  
                             </tr> 
                             <tr>
                                <td style="width:27%; min-width:180px; background:#eee; line-height: 25px; vertical-align: middle; 
                                    border-bottom:2px solid #fff; padding-left:8px;">Name der Bank *</td>
                               <td style="width:73%; line-height: 22px; border-bottom:2px solid #eee; vertical-align: middle; background:#ffffff; padding:0px; height:22px;"><input type="text" name="first_name" style="width:100%; border:none; background:#ffffff; height:24px;">
                               </td>  
                             </tr> 
                             <tr>
                                <td colspan="2" style="background:#fff; line-height: 25px; vertical-align: middle; 
                                    border-bottom:1px solid #fff; padding-left:8px;" colspan="2"><p>* Pflichtfelder</p>
                               </td>
                             </tr>
                             <tr>
                             ...
                             <tr>
                               <td colspan="2" style="padding:20px 0; text-align:center;">
                                  <button type="submit" class="button-l">JETZT ANMELDEN</button>
                               </td>
                             </tr>
...
function adjustHeights() {
    ...
    if(isFormOpen) {
        ...
        detail_block_ht += 830;  // (parseInt(form_height) + (priceFieldCount * 25)) - 130;
...
$(function() {
    ...
    $('.price-inp-sel').keyup(function (event) {
...
.price-inp-sel {
   width:39px; height:29px; text-align:center; border:none; background:#e8e8e8; text-align:center; padding:0; margin:0px;
}
