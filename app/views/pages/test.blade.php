...
@section('content')
    @if($page->teaser)
         <header>
            <div class="bg-ct picture-container" style="background-image: url('{{$DOMAIN}}/files/pages/{{$page->teaser->image}}');">
                <h1 class="text-center title-middle">
                    <span class="text-l">Max</span>
                    <span class="text-xl">Liebermann</span>
                    <span class="text-s">vom Freizeitvergnügen</span>
                    <span class="text-s">zum modernen Sport</span>
                </h1>
            </div>  
          </header>                  
    @endif    
    ...
    <div class="ce ce-menu container-fluid">
        ...
        @foreach($pg_links as $pl)
            <li><a href="/{{$menu_item}}/{{$pl->link}}" class="btn btn-default btn-raised @if($pl->current_link) active @endif">{{$pl->title_de}}</a></li>
        @endforeach    
            <!-- <li><a href="#" class="btn btn-default btn-raised">Button first</a></li>
            <li><a href="#" class="btn btn-default btn-raised">Button second</a></li>
            <li><a href="#" class="btn btn-default btn-raised">Button third</a></li> -->
        </ul>
    </div>
    ...
    @endforeach
        ...
        <!-- download start -->
        <div class="ce ce-download container-fluid">
            <h3 class="anchor">Downloads</h3>
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide ce-download-element" data-name="a1">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
                            </div>
                        </div>
                        <div>
                            Link Text 1
                    ...
                    <div class="swiper-slide ce-download-element" data-name="a2">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
                    ...
                    <div class="swiper-slide ce-download-element" data-name="a3">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
                    ...
                    <div class="swiper-slide ce-download-element" data-name="a4">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
                    ...
                    <div class="swiper-slide ce-download-element" data-name="ab">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
                    ...
                    <div class="swiper-slide ce-download-element" data-name="xyz">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
                    ...
                    <div class="swiper-slide ce-download-element" data-name="h7">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
                    ...
                    <div class="swiper-slide ce-download-element" data-name="42">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
                    ...
                    <div class="swiper-slide ce-download-element" data-name="4711">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
                    ...
                    <div class="swiper-slide ce-download-element" data-name="0815">
                        <div class="ce-download-element-overlay"></div>
                        <div>
                            <div>
                                <img src="/images/dummy/beispiel_quer.jpg" alt="#" title="#" />
